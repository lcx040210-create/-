      ...
      <nav className="bg-gray-900 text-white px-6 py-3">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <Link href="/admin/packages" className="text-sm text-gray-300 hover:text-white">课包管理</Link>
            <Link href="/admin/settlements" className="text-sm text-gray-300 hover:text-white">结算管理</Link>
          </div>
